...
import GmailProviderWrapper from "@/components/dashboard/GmailProviderWrapper";

export default async function GmailLayout({
  children,
}: {
  ...
  try {
    ...
    console.error("[GmailLayout] Error loading layout data:", error);
  }
  ...
  return (
    <GmailProviderWrapper initialEmails={emails}>
      {children}
    </GmailProviderWrapper>
  );
}
